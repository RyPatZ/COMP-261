...
public abstract class GUI {
	...
	private void initialise() {
		...
		JButton articulateIT = new JButton("Articulation Pt");
		articulateIT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				Mapper.iterativeAP();
				redraw();
			}
		...
		JButton MinSpanningT = new JButton("Min Spanning Tree");
		MinSpanningT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				Mapper.miniumSpanningTree();
				redraw();
			}
		});
		...
		loadquit.add(load);
		loadquit.add(quit);
		loadquit.add(articulateIT);
		loadquit.add(MinSpanningT);
